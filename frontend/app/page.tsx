    ...
    <main className="min-h-[calc(100vh-65px)] flex flex-col">
      <PageTransition>
        <div className="flex-1 max-w-5xl w-full mx-auto px-6 py-16 md:py-24">
          {/* Hero */}
          <motion.div
            className="mb-20 flex flex-col md:flex-row items-start md:items-center gap-8 md:gap-16"
            variants={stagger}
            initial="hidden"
            animate="visible"
          >
            ...
            >
              <Image
                src={isLight ? "/brand/restless-owl-mascot-light.svg" : "/brand/restless-owl-mascot.svg"}
          ...
          {/* Integration bar */}
          <motion.div
            className="grid grid-cols-2 md:grid-cols-4 gap-8 border-t border-border pt-10"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        <footer className="border-t border-border py-6">
          <div className="max-w-5xl mx-auto px-6 flex items-center justify-between text-xs text-muted-foreground">
            ...
            <a
              href="https://github.com/0xmihirsahu/restless"
              target="_blank"
